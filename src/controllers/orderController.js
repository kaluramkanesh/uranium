// const order1 = require("..//models/orderModel")
// const userId = require("..//models/userModel1")
// const productId = require("..//models/productModel")
// const createOrder = async function (req, res) {
//    let orderinformation = req.body
//    let productInformation=req.body
//    let userId1 = orderinformation.userId
//    let productId1 = productInformation.productId
//    let userVerification = await userId.findOne({ _id: userId1 })
//    let productVerification = await productId.findOne({ _id: productId1 })
//    res.send({ Data: userVerification })
// }
